...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="node()|@*">
	...
	<!-- tela geral do corel-->
	<!--/uiConfig/containers/container[@guid='bee85f91-3ad9-dc8d-48b5-d2a87c8b2109']/container[@guid='Framework_MainFrame-layout']/dockHost-->
	<!-- Documento-->
	<!--/uiConfig/views/viewTemplate[@guid='ab303a90-464d-5191-423f-613c4d1dcb2c']/container/container-->
	<!-- guid Hide command in menu context -->
	<!--/uiConfig/commandBars/commandBarData[@guid='1056b8d8-9185-46ee-af8e-77c7ba383a4e']/menu/item[@guidRef='6154a087-059d-4d9c-bac4-836b9377af23']-->
	...
	<xsl:template match="commandBarData[@guid='1056b8d8-9185-46ee-af8e-77c7ba383a4e']/menu/item[@guidRef='6154a087-059d-4d9c-bac4-836b9377af23']">
		...
		<xsl:if test="not(./item[@guidRef='a3481984-93a7-40b4-ab2c-c81df9f0407f'])">
			<item guidRef="a3481984-93a7-40b4-ab2c-c81df9f0407f"/>
		</xsl:if>
	...
	<xsl:template match="commandBarData[@guid='c2b44f69-6dec-444e-a37e-5dbf7ff43dae']/toolbar">
		<xsl:copy>
			<xsl:apply-templates select="node()|@*"/>
			<!-- Make sure we don't read the menu item it it already exists -->
			<xsl:if test="not(./item[@guidRef='8a30dae3-99e8-4a5c-bfdb-00ef9279e18e'])">
				<item guidRef="8a30dae3-99e8-4a5c-bfdb-00ef9279e18e"/>
			</xsl:if>
		</xsl:copy>
	</xsl:template>
